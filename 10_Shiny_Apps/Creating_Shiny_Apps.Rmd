...
The ui begins with the *fluidePage()* function and includes items like the shiny app title, and the types of interactives you desire to have in the app. Next we see the *titlePanel()* function which applies a large title to your Shiny app. This element is not necessary, but often used.
```{r ui, eval=FALSE}
