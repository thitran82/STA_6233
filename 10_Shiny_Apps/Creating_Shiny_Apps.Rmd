...
ui <- fluidPage() - This is the user interface for the applicaton
...
All shiny apps will have this very basic template. They obviously will be much more detailed as you build your app, but these components are neccessary for your app to properly function.
