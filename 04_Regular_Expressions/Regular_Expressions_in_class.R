...
#### Simple Matching ####
#Let's create a simple list of five fruits as strings to work with.
...
#Find any spelling of grey/gray
grep("gr(e|a)y", mm)  
grep("gr[ea]y", mm)
